...
class CampanhaController {
    async criarCampanha(req: Request | any, res: Response): Promise<Response> {
        ...
        try {
            ...
            if (novaCampanha === null) {
                logger.error(`[Erro ao criar campanha] Method: ${req.method} - URL: ${req.url} - Usuário: ${req.userId} - { Host: ${req.headers.host} - User-agent: ${req.headers["user-agent"]} }`);
                
                return res.json({ msg: "Erro ao tentar criar a campanha" });
            } else {
                logger.info(`[Criação bem-sucedida] Campanha ${novaCampanha.nomeCurto} criada por ${req.userId} - Method: ${req.method} - URL: ${req.url} - { Host: ${req.headers.host} - User-agent: ${req.headers["user-agent"]} }`);
    ...
    async pesquisarCampanhaPorSubstring(req: Request | any, res: Response): Promise<Response> {
        try {
            ...
            if (campanhas === null) {
                logger.error(`[Erro ao buscar campanha(s)] Msg: "Nenhuma campanha encontrada" - Method: ${req.method} - URL: ${req.url} - Usuário: ${req.userId} - { Host: ${req.headers.host} - User-agent: ${req.headers["user-agent"]} }`);
    ...
    async todasAsCampanhas(req: Request | any, res: Response): Promise<Response> {
        try {
            ...
            if (campanhas === null) {
                logger.error(`[Erro ao buscar campanhas] Msg: "Nenhuma campanha encontrada" - Method: ${req.method} - URL: ${req.url} - Usuário: ${req.userId} - { Host: ${req.headers.host} - User-agent: ${req.headers["user-agent"]} }`);
                
                return res.status(400).json({ msg: "Nenhuma campanha encontrada" });
            } else {
                logger.info(`[Busca bem-sucedida] Requição feita por ${req.userId} - Method: ${req.method} - URL: ${req.url} - { Host: ${req.headers.host} - User-agent: ${req.headers["user-agent"]} }`);
    ...
    async todasAsCampanhasAtivas(req: Request | any, res: Response): Promise<Response> {
        try {
            ...
            if (campanhas === null) {
                logger.error(`[Erro ao buscar campanhas ativas] Msg: "Nenhuma campanha encontrada" - Method: ${req.method} - URL: ${req.url} - Usuário: ${req.userId} - { Host: ${req.headers.host} - User-agent: ${req.headers["user-agent"]} }`);
                
                return res.status(400).json({ msg: "Nenhuma campanha ativa encontrada" });
            } else {
                logger.info(`[Busca bem-sucedida] Requisição feita por ${req.userId} - Method: ${req.method} - URL: ${req.url} - { Host: ${req.headers.host} - User-agent: ${req.headers["user-agent"]} }`);
    ...
    async melhoresCampanhas(req: Request | any, res: Response): Promise<Response> {
        try {
            ...
            if (top5Campanhas === null) {
                logger.error(`[Erro ao buscar melhores campanhas] Msg: "Nenhuma campanha encontrada" - Method: ${req.method} - URL: ${req.url} - Usuário: ${req.userId} - { Host: ${req.headers.host} - User-agent: ${req.headers["user-agent"]} }`);
    ...
    async campanhaPorUrl(req: Request | any, res: Response): Promise<Response> {
        try {
            ...
            if (campanha === null) {
                logger.error(`[Erro ao buscar campanha] Msg: "Nenhuma campanha encontrada" - Method: ${req.method} - URL: ${req.url} - Usuário: ${req.userId} - { Host: ${req.headers.host} - User-agent: ${req.headers["user-agent"]} }`);
    ...
    async atualizarCampanha(req: Request | any, res: Response): Promise<Response> {
        try {
            ...
            logger.info(`[Atualização bem-sucedida] Requisição feita por ${req.userId} - Method: ${req.method} - URL: ${req.url} - { Host: ${req.headers.host} - User-agent: ${req.headers["user-agent"]} }`);
    ...
    async darLikeOuDislike(req: Request | any, res: Response): Promise<Response> {
        try {
            ...
            if (campanha === null) {
                ...
                logger.info(`[Atualização de LikeOuDislike bem-sucedida] Requisição feita por ${req.userId} - Method: ${req.method} - URL: ${req.url} - { Host: ${req.headers.host} - User-agent: ${req.headers["user-agent"]} }`);
    ...
    async fazerComentario(req: Request | any, res: Response): Promise<Response> {
        try {
            ...
            if (campanha === null) {
                ...
                logger.info(`[Comentário bem-sucedido] Requisição feita por ${req.userId} - Method: ${req.method} - URL: ${req.url} - { Host: ${req.headers.host} - User-agent: ${req.headers["user-agent"]} }`);
    ...
    async apagarComentario(req: Request | any, res: Response): Promise<Response> {
        try {
            ...
            if (campanha === null) {
                ...
                logger.info(`[Comentário Apagado] Requisição feita por ${req.userId} - Method: ${req.method} - URL: ${req.url} - { Host: ${req.headers.host} - User-agent: ${req.headers["user-agent"]} }`);
    ...
    async responderComentario(req: Request | any, res: Response): Promise<Response> {
        try {
            ...
            if (campanha === null) {
                ...
                logger.info(`[Resposta bem-sucedida] Requisição feita por ${req.userId} - Method: ${req.method} - URL: ${req.url} - { Host: ${req.headers.host} - User-agent: ${req.headers["user-agent"]} }`);
    ...
    async apagarResposta(req: Request | any, res: Response): Promise<Response> {
        try {
            ...
            if (campanha === null) {
                ...
                logger.info(`[Resposta apagada] Requisição feita por ${req.userId} - Method: ${req.method} - URL: ${req.url} - { Host: ${req.headers.host} - User-agent: ${req.headers["user-agent"]} }`);
